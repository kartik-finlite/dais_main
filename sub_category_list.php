...
<!-- LOCAL PAGE LAVEL JS -->
<script src="assets/web/local_assets/js/sub_category_list.js"></script>
            ...
            <div class="card-header">
              <div class="row">
                <div class="col-6 col-md-6 col-xs-6">
                  <h3 class="card-title mt-2">Sub Category Listing</h3>
                </div>
                <div class="col-6 col-md-6 col-xs-6 text-right">
                  <button type="button" onclick="return getPage('sub_category.php');" class="pull-right btn btn-primary">Add</button>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tbl-celebrities-listing" class="table table-bordered table-striped table_responsive" style="width:100%;">
                <thead>
                  <tr>
                    <th>Category Name</th>
