        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Credentials Details</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="change_password_details" name="change_password_details">
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6">
                    <div id="form-group-password" class="form-group">
                      <label for="password">New Password&nbsp;<span class="is-required">*</span></label>
                      <input type="password" name="password" class="form-control" id="password" placeholder="Please enter new password." value="">
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6">
                    <div id="form-group-confirmPassword" class="form-group">
                      <label for="confirmPassword">Confirm Password&nbsp;<span class="is-required">*</span></label>
                      <input type="password" name="confirmPassword" class="form-control" id="confirmPassword" placeholder="Enter confirm password."  value="">
                      <small id="confirmPassword-error" class="form-text text-muted"></small>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <button type="submit" id="submitFormDetailsForPassword" name="btn-admin-change-credentials" onclick="return validatePageForChangePassword();" class="btn btn-primary">Submit</button>
              </div>
            </form>
          </div>
          <!-- /.card -->
