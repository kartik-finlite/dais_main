...
<script src="assets/web/local_assets/js/add-category.js"></script>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="add_category_details" name="add_category_details">
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6">
                    <div id="form-group-category_name" class="form-group">
                      ...
                      <input type="text" name="category_name" class="form-control" id="category_name" placeholder="Please enter category name." value="<?php echo (isset($data['name']) && $data['name'] != "") ? $data['name'] : ""; ?>">
                      <small id="category_name-error" class="form-text text-muted"></small>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <button type="submit" id="update_category_button" name="btn-admin-change-credentials" onclick="return update_validate();" class="btn btn-primary pl-5 pr-5">UPDATE</button>
                  <?php
                }else{
                  ?>
                <button type="submit" id="add_category_button" name="btn-admin-change-credentials" onclick="return validate_add_category();" class="btn btn-primary pl-5 pr-5">SUBMIT</button>
                  <?php
                }
                ?>
