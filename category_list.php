...
<!-- LOCAL PAGE LAVEL JS -->
<script src="assets/web/local_assets/js/category_list.js"></script>
            ...
            <div class="card-header">
              <div class="row">
                <div class="col-6 col-md-6 col-xs-6">
                  <h3 class="card-title mt-2">Category Listing</h3>
                </div>
                <div class="col-6 col-md-6 col-xs-6 text-right">
                  <button type="button" onclick="return getPage('category.php');" class="pull-right btn btn-primary">Add</button>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
